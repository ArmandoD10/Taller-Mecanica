...
<style>
    ...
    #modalCompra .modal-body { max-height: 70vh; overflow-y: auto; }
</style>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body bg-light p-4">
                    <form id="formCompraCabecera">
                        ...
                        <h6 class="fw-bold text-primary border-bottom pb-2 mb-3"><i class="fas fa-file-invoice me-2"></i>1. Datos de la Orden</h6>
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <label class="fw-bold">Estado de Orden</label>
                    ...
                    <h6 class="fw-bold text-primary border-bottom pb-2 mb-3"><i class="fas fa-boxes me-2"></i>2. Agregar Artículos (Carrito)</h6>
                    <div class="row align-items-end mb-3 bg-white p-3 rounded border border-2 border-secondary">
                        <div class="col-md-5">
                            <label class="fw-bold fs-6">Artículo / Repuesto</label>
                            <select class="form-select border-dark" id="selector_articulo">
                                <option value="">Seleccione o busque artículo...</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                            <label class="fw-bold fs-6">Precio U.</label>
                            <input type="number" class="form-control border-dark text-end fw-bold" id="input_precio" placeholder="0.00" step="0.01">
                        </div>
                        <div class="col-md-2">
                            <label class="fw-bold fs-6">Cantidad</label>
                ...
                <div class="modal-footer bg-white border-top">
                    ...
                    <button type="button" class="btn btn-success" id="btnGuardarCompra"><i class="fas fa-save me-2"></i>Guardar y Procesar Orden</button>
                </div>
            </div>
        </div>
    </div>
