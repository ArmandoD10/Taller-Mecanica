...
<style>
    ...
    /* Estilo para el buscador dinámico de clientes */
    #lista_clientes_busqueda { z-index: 1050; max-height: 200px; overflow-y: auto; }
    ...
    <div class="container-fluid px-4">
        ...
        <div class="hoja-inspeccion" id="hoja-impresion">
            <form id="formulario_inspeccion" method="POST">
                ...
                <div class="section-title text-start ps-3">ESTADO GENERAL DEL VEHÍCULO</div>
                ...
                <div class="row px-2">
                    <div class="col-4">
                        ...
                        <table class="table-inspeccion">
                            <thead>
                                <tr><th>Elemento</th><th>B</th><th>F</th><th>D</th></tr>
                            </thead>
                            <tbody>
                                <?php
                                $items = ['Beeper', 'Pito/Bocina', 'Luces int.', 'Aire Cond.', 'Radio', 'Cristales', 'Seguros', 'Retrovisor'];
                                foreach ($items as $i => $item) {
                                    echo "<tr><td>$item</td><td class='text-center'><input type='radio' name='int_$i' value='B'></td><td class='text-center'><input type='radio' name='int_$i' value='F'></td><td class='text-center'><input type='radio' name='int_$i' value='D'></td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
                        ...
                        <table class="table-inspeccion">
                            ...
                            <tbody>
                                ...
                                foreach ($items_ext as $i => $item) {
                                    echo "<tr><td>$item</td><td class='text-center'><input type='radio' name='ext_$i' value='B'></td><td class='text-center'><input type='radio' name='ext_$i' value='F'></td><td class='text-center'><input type='radio' name='ext_$i' value='D'></td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
                        ...
                        <table class="table-inspeccion">
                            ...
                            <tbody>
                                ...
                                foreach ($items_mot as $i => $item) {
                                    echo "<tr><td>$item</td><td class='text-center'><input type='radio' name='mot_$i' value='B'></td><td class='text-center'><input type='radio' name='mot_$i' value='F'></td><td class='text-center'><input type='radio' name='mot_$i' value='D'></td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
                ...
                <div class="row px-2">
                    ...
                    <div class="col-9">
                        <div class="car-diagram-box">
                            <div class="row gx-1">
                                <div class="col-6 border-end" style="height: 300px;"><img src="../../img/vehicle-diagram-Converted.jpg" class="img-referencia" style="max-height: 100%;"></div>
                                <div class="col-6" style="height: 300px;"><img src="../../img/interior.png" class="img-referencia" style="max-height: 100%;"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-4 text-center">
                    <div class="col-6"><div style="border-top: 1px solid #000; width: 80%; margin: 0 auto; padding-top: 3px;"><strong>Firma Asesor</strong></div></div>
                    <div class="col-6"><div style="border-top: 1px solid #000; width: 80%; margin: 0 auto; padding-top: 3px;"><strong>Firma Cliente</strong></div></div>
                </div>
            </form>
        </div>
    </div>
